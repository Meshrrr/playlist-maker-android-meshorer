package com.practicum.playlist_maker_android_meshorer.creator

import com.practicum.playlist_maker_android_meshorer.data.dto.TrackDto

class Storage {
    private val listTracks = listOf(
        TrackDto(
            trackName = "Владивосток 3000",
